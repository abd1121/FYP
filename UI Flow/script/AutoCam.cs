...
namespace UnityStandardAssets.Cameras
{
    ...
    {
        [SerializeField] private float m_MoveSpeed = 7; // 0ow fast the rig will move to keep up with target's position
       ...
       private float m_TurnSpeedVelocityChange; // The change in the turn speed velocity
        public Vector3 m_RollUp ;// The roll of the camera around the z axis ( generally this will always just be up )
